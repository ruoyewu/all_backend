v2_base_categories = {
    'one': {
        'index': 'http://v3.wufazhuce.com:8000/api/onelist/idlist/',
        'home': 'http://v3.wufazhuce.com:8000/api/onelist/',
...
def get_default_list_item():
    return {'id': '', 'title': '', 'forward': '', 'image': '', 'video': '', 'icon': '', 'date': '', 'author': '',
            'type': '', 'category': '', 'pic_author': '', 'word_author': '', 'content': [], 'time_millis': '',
            'next': '', 'original_url': '', 'age': ''}


def get_default_detail_item():
    return {'title': '', 'subtitle': '', 'author': '', 'date': '', 'content': []}


def get_default_content_item():
    return {'txt': '', 'img': '', 'li': '', 'h': '', 'txt_cen': '', 'video': ''}
